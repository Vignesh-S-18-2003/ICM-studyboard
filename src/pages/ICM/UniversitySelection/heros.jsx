...
const hero = ["/images/UniversitySelection/u1.jpg", "/images/UniversitySelection/u1.jpg"];
          ...
          <div className="container">
            <div className="row  ">
              ...
              <div className="position-relative pt200 pr0 mr0">
                  ...
                  <h3
  className="banner-text text-white ff-heading mb25 mr25 animate-up-3 p15"
  style={{ color: 'orange' }} // Change color to orange
>
  Find Your Perfect Academic Destination
</h3>
<h4
  className="banner-subtext text-white mb25 animate-up-4 p15"
  style={{ color: 'orange' }} // Change color to orange
>
  Discover and secure your spot at the perfect academic institution, tailored to your goals and ambitions.
</h4>
