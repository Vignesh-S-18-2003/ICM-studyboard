  ...
  const newCategories = [
    {
      ...
      description:
        "We ensure you select a university known for excellence in your chosen field, offering top-notch programs, experienced faculty, and research opportunities that align with your academic interests.",
      iconClass: "icon-uni-help", // Placeholder for an icon class
    },
    {
      title: "Academic Strengths and Course Offerings",
      description:
        "We provide insights into universities with strong industry connections, internship programs, and high employability rates, ensuring you have the best career prospects and networking opportunities after graduation.",
      iconClass: "icon-academic-strength", // Placeholder for an icon class
    },
    {
      title: "Budget and Financial Aid",
      description:
        "We help you find universities that fit your financial situation by considering tuition fees, living expenses, and financial aid opportunities, including scholarships and grants, so you can make a cost-effective choice.",
      iconClass: "icon-financial-aid", // Placeholder for an icon class
    },
    {
      title: "Location Preferences",
      description:
        "Whether you prefer an urban or rural setting, we match you with universities in locations that suit your lifestyle, cultural interests, and future plans, including safety, climate, job markets, and overall community engagement.",
