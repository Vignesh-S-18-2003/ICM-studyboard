...
function AdmissionDialer() {
  ...
  return (
    <div className='text-center bg-dark pb90'>
    <h1 className='text-light pt90'>Connect with our counselors ! </h1>
...
export default AdmissionDialer
