...
export default function AdmissionCategory1() {
  ...
  const newCategories = [
    {
      ...
      description:
        "Get one-on-one guidance tailored to your academic goals, interests, and preferred institutions.",
      iconClass: "icon-uni-help", // Placeholder for an icon class
    },
    {
      title: "Application Material Review",
      description:
        "Expert review of your application documents, including essays, resumes, and recommendation letters, to enhance your chances of success",
      iconClass: "icon-academic-strength", // Placeholder for an icon class
    },
    {
      title: "Admission Requirements Check",
      description:
        "Ensure all your application materials meet specific university requirements and deadlines",
