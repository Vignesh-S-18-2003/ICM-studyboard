...
import { Scholarshipfreelancer } from "../ScholarshipAustralia/ScholarshipFreelancer";
import SAustraliaCard from "../ScholarshipAustralia/SAustraliaCard";
import SUKCard from "../ScholarshipAustralia/SUKCard";

export default function ScholarshipUniversity() {
          ...
          <div className="row align-items-center wow fadeInUp">
            <div className="col-lg-9">
              <div className="main-title">
                <h2 className="title">Popular Scholarships!</h2>
