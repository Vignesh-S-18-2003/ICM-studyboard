          ...
          <div className="col-xl-7">
            <div className="home17-hero-content">
              ...
              <h4 className="text-white text animate-up-2">
                Unlock the gateway to world-class education in Germany with
                scholarships designed for your academic journey.
              </h4>
              <p>We guide you in discovering and applying for scholarships at Germany’s prestigious institutions. Whether it's undergraduate, postgraduate, or doctoral levels, we help you access free scholarships tailored to your needs.</p>
