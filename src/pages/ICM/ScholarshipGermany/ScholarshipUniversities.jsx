          ...
          <div className="row align-items-center wow fadeInUp">
            <div className="col-lg-9">
              <div className="main-title">
                <h2 className="title">Top Universities in Germany!</h2>
                <p>
                  Explore the leading institutions in Germany, renowned for their high-quality education, research opportunities, and diverse programs across multiple disciplines.
                </p>
              </div>
            </div>
