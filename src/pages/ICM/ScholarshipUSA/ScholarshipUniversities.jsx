          ...
          <div className="row align-items-center wow fadeInUp">
            <div className="col-lg-9">
              <div className="main-title">
                <h2 className="title">Top Universities in the USA!</h2>
                <p>Explore the best institutions in the United States, offering a wide variety of programs to help you excel in your educational journey.</p>
              </div>
            </div>
