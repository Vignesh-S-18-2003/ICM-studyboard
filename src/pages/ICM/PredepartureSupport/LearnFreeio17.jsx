import LearnFreeioCard from "./LearnFreeioCard";
import { Swiper, SwiperSlide } from "swiper/react";
import "swiper/css";
import "swiper/css/navigation";
import "swiper/css/pagination";
import { Navigation, Pagination } from "swiper";
import { learnFreeio3 } from "@/data/project";
        ...
        <div className="row align-items-center wow fadeInUp">
          <div className="col-lg-9 mx-auto">
            <div className="main-title text-center">
              <h2 className="title">What Students Say About Pre-Departure Support</h2>
              <p className="paragraph">
                Discover how pre-departure support has helped students prepare for their journey abroad, ensuring a smooth transition.
              </p>
            </div>
          </div>
        </div>
