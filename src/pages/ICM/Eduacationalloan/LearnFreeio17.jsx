...
import { learnFreeio2 } from "@/data/project";
        ...
        <div className="row align-items-center wow fadeInUp">
          <div className="col-lg-9 mx-auto">
            <div className="main-title text-center">
              <h2 className="title">What Students Say About Educational Loans</h2>
              <p className="paragraph">
                Discover how educational loans have transformed the lives of students pursuing their dreams abroad.
              </p>
            </div>
          </div>
        </div>
