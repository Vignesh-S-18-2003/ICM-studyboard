import { featuresTwo, frelancersFeatures } from "./features";
  ...
  return (
    <section className="cta-banner-about2 at-home17 maxw1700 mx-auto position-relative pt60-lg pb60-lg">
          ...
          <div className="col-lg-7 col-xl-5 offset-xl-1 wow fadeInRight mb60-xs mb100-md">
            <div className="mb30">
              <div className="main-title">
                <h2 className="title">
                We help you secure loans for {" "}
                  <br className="d-none d-xl-block" />studying abroad with flexible repayment options
                </h2>
              </div>
            </div>
            <div className="why-chose-list">
              {frelancersFeatures.map((elm, i) => (
                ...
                <div className="list-content flex-grow-1 ml20">
                  <b>
                    <h4 className="mb-1" style={{ color: "orange" }}>{elm.title}</h4> {/* Inline style for color */}
                  </b>
      ...
      <img
        ...
        src="/images/EducationalLoan/e9.png"
        alt=" image "
      />
    </section>
  );
