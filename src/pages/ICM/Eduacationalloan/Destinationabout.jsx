          ...
          <div className="col-xl-12">
            <div className="ui-content mt45 mb100">
              ...
              <h5 className="mb25 ff-heading text">
                <i className="fas fa-university" style={{ color: 'orange', marginRight: '10px' }}></i>
                Discover everything you need to know about educational loans, from eligibility criteria to repayment options. Learn how to secure funding for tuition, living expenses, and other costs associated with international education.
              </h5>
              <h5 className="mb25 ff-heading text">
