            ...
            >
              <div className="error_page_content text-center text-xl-start">
                ...
                <p className="text fz15 mb20">
                  Embark on a journey to Dubai, where renowned universities and stunning landscapes await. Enhance your skills with high-quality education and embrace a multicultural environment that opens doors to endless opportunities.
                </p>
