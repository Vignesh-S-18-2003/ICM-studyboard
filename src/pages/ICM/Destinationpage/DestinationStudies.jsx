...
import SAustraliaCard from "../ScholarshipAustralia/SAustraliaCard";
import { Destinationfreelancer } from "../ScholarshipAustralia/ScholarshipFreelancer";
import DestinationCard from "./DestinationCard";

export default function DestinationStudies() {
          ...
          <div className="row align-items-center wow fadeInUp">
            <div className="col-lg-9">
              <div className="main-title">
                <h2 className="title">Top Universities in Australia!</h2>
              </div>
            </div>
            ...
            <div className="col-lg-12">
              <div className="navi_pagi_bottom_center">
                {showSwiper && (
                  ...
                  >
                    {Destinationfreelancer.slice(0, 3).map((item, index) => (
