            ...
            <div className="tab-pane fade show active" id="pills-item1">
              <div className="shop-single-item mb10 bdr1 bdrs8 text-center py-5">
                <a className="popup-img" onClick={() => setToggler(!toggler)}>
                  <img className="wa" src={data.gallery[0]} alt="product" />
                </a>
              </div>
            </div>
        ...
        {data ? (
          <ul className="nav nav-pills mb-3" id="pills-tab">
            ...
            <li className="nav-item">
              ...
              >
                <img src="/images/shop/shop-single-3.png" alt="product" />
              </button>
            </li>
            <li className="nav-item">
              <button
              ...
              >
                <img src="/images/shop/shop-single-4.png" alt="product" />
              </button>
            </li>
            <li className="nav-item">
              <button
              ...
              >
                <img src="/images/shop/shop-single-5.png" alt="product" />
              </button>
            </li>
          </ul>
        ) : (
          <ul className="nav nav-pills mb-3" id="pills-tab">
            <li className="nav-item">
              <button
                ...
                data-bs-target="#pills-item1"
              >
                <img src="/images/shop/shop-single-2.png" alt="product" />
              </button>
            </li>
            <li className="nav-item">
              <button
