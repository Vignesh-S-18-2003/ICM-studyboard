...
function ScholarshipUKFact() {
  return (
    <div
    className="col-12 wow fadeInRight mt-2 pt90 "
    data-wow-delay="100ms"
  >
    <div className="cta-style6 text-center mb100 wow fadeInUp">
      <h1 className=" mb25">
      ...
      <Link to="/contact" className='bgc-thm2 text-light  p10 rounded wow fadeInUp'>
      Subscribe Now
      </Link>
    </div>
  </div>
...
export default ScholarshipUKFact
