...
const hero = ["/images/StudyAbroadStep3/s1.jpg", "/images/StudyAbroadStep3/s1.jpg"];
          ...
          <div className="container">
            <div className="row  ">
              ...
              <div className="position-relative pt200 pr0 mr0">
                  ...
                  <h3 className="banner-text text-white ff-heading mb25 mr25 animate-up-3 p15">Follow our simple process to kickstart your international education journey                  </h3>
