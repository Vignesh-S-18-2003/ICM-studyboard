...
import { freelancer1, hightedRated1 } from "@/data/product"; // These imports can be adjusted based on the updated context.
          ...
          <div className="row align-items-center wow fadeInUp">
            <div className="col-lg-9">
              <div className="main-title">
                <h2 className="title">Top Universities in Canada!</h2>
                <p>Explore the best institutions in Canada, offering a wide variety of programs to help you excel in your educational journey.</p>
              </div>
            </div>
