          ...
          <div className="col-xl-7">
            <div className="home17-hero-content">
              ...
              <h4 className="text-white text animate-up-2">
                Unlock the best educational opportunities in Canada with
                affordable programs tailored for your success.
              </h4>
              <p>
                We help you find and select colleges and scholarships for your studies in Canada. Get free scholarships for every level of education, from diploma programs to graduate studies.
              </p>
