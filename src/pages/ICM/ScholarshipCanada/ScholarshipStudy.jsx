      ...
      <div className="col-lg-9 mx-auto pt90">
        <div className="main-title text-center mb30">
          ...
          <h5 className="paragraph">
            Follow the steps below to start your Canadian education journey
          </h5>
        </div>
      </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-7 col-xl-4 offset-xl-1">
              <div className="cta-style5">
                <h2 className="cta-title mb10">Choose Your Program</h2>
                <p className="cta-text mb40">
                  Canadian educational institutions offer a wide range of programs across various disciplines. Whatever your career or learning goal, there’s a program that can support your journey. Arts and Humanities, Science and Engineering, Business and Management, Health Sciences.
                </p>
            ...
            <div className="col-lg-7 col-xl-4 offset-xl-1">
              <div className="cta-style5">
                ...
                <p className="cta-text mb30">
                  Every student dreams of studying in a specific country and university. We help you understand your admission chances at Canadian universities and guide you through the application process.
                </p>
                <div className="app-widget at-home6">
                  <div className="row d-flex align-items-center">
                    <div className="col-auto">
            ...
            <div className="col-lg-7 col-xl-4 offset-xl-1">
              <div className="cta-style5">
                ...
                <p className="cta-text mb60">
                  Effectively plan your budget for studying in Canada with our expert guidance. We assist you in navigating tuition fees, living expenses, and available scholarships, ensuring a financially secure study experience.
                </p>
                <div className="app-widget at-home6">
                  <div className="row d-flex align-items-center">
                    <div className="col-auto">
          ...
          <div className="row">
            <div className="col-lg-7 col-xl-4 offset-xl-1">
              <div className="cta-style5">
                ...
                <p className="cta-text mb60">
                  Simplify your Canadian student visa process with our professional guidance. We assist you in meeting all visa requirements, ensuring a smooth and quick application process.
                </p>
                <div className="app-widget at-home6">
                  <div className="row d-flex align-items-center">
                    <div className="col-auto">
