...
const hero = ["/images/StudyAbroadStep5/s1.jpg", "/images/StudyAbroadStep5/s1.jpg"];
              ...
              <div className="col-xxl-12">
                <div className="position-relative pt200 pr0 mr0">
                  ...
                  <h3 className="banner-text text-white ff-heading mb25 mr25 animate-up-3 p15">
                    Get ready for your study abroad journey with the right preparations. From packing essentials to finalizing your travel plans, ensure a smooth departure.
                  </h3>
